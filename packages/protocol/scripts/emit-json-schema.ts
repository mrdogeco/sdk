...
const RESOURCE_SCHEMAS = {
  ...
  SportName: resources.SportName,
  MatchStatus: resources.MatchStatus,
  MatchStats: resources.MatchStats,
  // Per-sport stats variants — emitted individually so non-TS SDKs can
  // generate per-sport classes/structs and skip the union machinery.
  SoccerStats: resources.SoccerStats,
  TennisStats: resources.TennisStats,
  BasketballStats: resources.BasketballStats,
  AmericanFootballStats: resources.AmericanFootballStats,
  BaseballStats: resources.BaseballStats,
  IceHockeyStats: resources.IceHockeyStats,
